...
namespace BonayogDianaMae.PrelimExam.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            else
            {
                ...
                Value.Consumption = (Value.Hours * Value.Generation);
                Value.Message = "Your Generation is " + Value.Generation?.ToString("##.##");
                ...
                Value.Consumption = (Value.Hours * Value.Distribution);
                Value.Message = "Your Distribution is " + Value.Distribution?.ToString("##.##");
                ...
                Value.Consumption = (Value.Hours * Value.Transmission);
                Value.Message = "Your Transmission is " + Value.Transmission?.ToString("##.##");
        ...
        public class ValueViewModel
        {
            ...
            public string? AirConditionUnits { get; set; }
